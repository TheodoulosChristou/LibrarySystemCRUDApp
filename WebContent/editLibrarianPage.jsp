        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            ...
            <button type="button" class="btn btn-warning" onclick="backToMainPage()">Main Page</button>
              <h2 class="text-uppercase text-center mb-5">Edit Librarian</h2>

              <form id="editLibrarianForm" method="post">
              
               <div class="form-outline mb-4">
                  <input type="text" id="i" name="i" class="form-control form-control-lg" readonly/>
                ...
                <div class="d-flex justify-content-center">
                  <button class="btn btn-success" onclick="editLibrarian()">Edit</button>
                </div>
              </form>
            </div>
          </div>
...
<script>
	...
	const country = localStorage.getItem('c');
	...
	document.getElementById('em').setAttribute("value", email);
